...
- use make to see the basic version of the project
```
make
```

- use make bonus to include the minimap and shader
```
make bonus
```

## Usage
You can now run the executable with any map file from the resources folder, for example
```
...
We also created a test script, that test our 22 created maps for any possible error.
```
./map_test.sh
```
...
- Special shoutout to my teammate Jacob, whose dedication, ideas, and collaborative spirit were fundamental in bringing this project to life. Jacob's expertise in shader implementation significantly enhanced our project's visual appeal.
